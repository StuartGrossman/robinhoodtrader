...
class ExpandedContractTracker:
    def __init__(self, contract_key, option_type, price_cents):
...
class SPYExpandedTerminal:
    ...
    async def find_and_expand_contracts(self):
        ...
        try:
            ...
            # Navigate to options page in main context
    ...
    async def create_expanded_contract_context(self, price_cents):
        ...
        try:
            ...
            tracker = ExpandedContractTracker(contract_key, self.option_type, price_cents)
            tracker.page = page
        ...
        try:
            ...
            if extracted_fields > 0:
                ...
                try:
                    ...
                    self.log(f"  ⚠️ Debug analysis failed: {debug_error}")
